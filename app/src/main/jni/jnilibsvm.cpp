...
extern "C" void Java_menrva_vortexapp_vortexcontrol_ControlActivity_jniSvmTrain(JNIEnv *env, jobject obj, jstring cmdIn){
...
extern "C" void Java_menrva_vortexapp_vortexcontrol_ControlActivity_jniSvmPredict(JNIEnv *env, jobject obj, jstring cmdIn){
	const char *cmd = env->GetStringUTFChars(cmdIn, 0);
...
*/
extern "C" JNIEXPORT int JNICALL Java_menrva_vortexapp_vortexcontrol_ControlActivity_testInt(JNIEnv * env, jobject obj){
	return 5566;
}

extern "C" void Java_menrva_vortexapp_vortexcontrol_ControlActivity_testLog(JNIEnv *env, jobject obj, jstring logThis){
